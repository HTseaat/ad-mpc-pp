...
class ADMPC:
    ...
    async def mult(self, mult_values, mult_triples, layer): 
        ...
        # This simulates an adversarial attack injected at layer = 3
        # At layer = 3, honest node 0 will go offline
        if layer == 3 and self.my_id != 0: 
            batch_rec_list = []
            # We assume nodes 1, 2, 3, 4, 5 are Byzantine nodes, and all their inputs are set to 0
            byzantine_nodes = [1,2,3,4,5]
