...
class HbmpcConfig(object):
    ...
    def load_config():
        ...
        parser.add_argument(
            ...
            default=None,
            help="(Optional) UNIX‑epoch timestamp at which to start ADMPC. "
                 "If omitted, the protocol starts immediately.",
        )
        ...
        HbmpcConfig.total_cm = config["total_cm"]
        ...
        assert HbmpcConfig.total_cm is not None, "total_cm: missing"
