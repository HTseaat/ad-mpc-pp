...
from beaver.admpc2_dynamic_dumbo_shuffle_beaver import ADMPC_Dynamic
...
async def _run(
    ...
    async with ProcessProgramRunner(
        ...
        with ADMPC_Dynamic(
            ...
            logging.info(f"Dumbo shuffle Beaver ADMPC start time: {begin_time}")
...
if __name__ == "__main__":
    logging.info("Running Dumbo shuffle Beaver ADMPC ...")
