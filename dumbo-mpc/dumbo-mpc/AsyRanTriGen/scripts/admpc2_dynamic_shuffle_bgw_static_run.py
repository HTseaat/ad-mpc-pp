...
from beaver.admpc2_dynamic_shuffle_bgw_static import ADMPC_Dynamic
...
async def _run(
    ...
    async with ProcessProgramRunner(peers, n * layers, t, my_send_id) as runner:
        ...
        with ADMPC_Dynamic(
            ...
            logging.info(f"Shuffle BGW-static ADMPC start time: {begin_time}")
...
if __name__ == "__main__":
    logging.info("Running Shuffle BGW-static ADMPC ...")
