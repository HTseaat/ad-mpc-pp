...
ARCHIVE="${N128_CONFIG_ARCHIVE:-/opt/dumbo-mpc/dumbo-mpc/AsyRanTriGen/conf/admpc_300_8_128.tar.xz}"
ARCHIVE_NAME="admpc_300_8_128.tar.xz"
CONFIG_NAME="admpc_300_8_128"
EXPECTED_FILES=1024
